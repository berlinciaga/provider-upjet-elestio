...
export TERRAFORM_PROVIDER_SOURCE ?= elestio/elestio
export TERRAFORM_PROVIDER_REPO ?= https://github.com/elestio/terraform-provider-elestio
export TERRAFORM_PROVIDER_VERSION ?= 0.24.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-elestio
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-elestio_v0.24.0
...
xpkg.build.provider-upjet-elestio: do.build.images
